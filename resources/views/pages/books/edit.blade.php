...
@section('content')
    <div class="max-w-2xl mx-auto">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold text-gray-800">✏️ Редактировать книгу</h1>
        ...
        <div class="bg-white rounded-lg shadow p-6">
            <form method="POST" action="{{ route('books.update', $book) }}">
                ...
                <div class="mb-6">
                    ...
                    <textarea name="description" rows="6" class="w-full px-3 py-2 border border-gray-300 rounded-lg">{{ old('description', $book->description) }}</textarea>
                </div>
